...
export const i18n = {
  en: {
    ...
    expertInsertRepeat: 'Insert repeat prefix',
    ...
    formulaPlaceholder: 'e.g. 2d6 + 4  ·  1d20 - 2  ·  1d20 + 4 ; 1d8 + 2  ·  3x 1d20 + 6 ; 1d10',
    formulaPreviewEmpty: 'Enter a formula or click dice above',
    formulaInvalid: 'Formula not recognised — try 2d6 + 4, 3x1d20 + 6, or 1d20 + 4 ; 1d8 + 2',
    rollBtn: 'Roll!',
    totalLabel: 'Total',
  ...
  fr: {
    ...
    expertInsertRepeat: 'Insérer un préfixe de répétition',
    ...
    formulaPlaceholder: 'ex. 2d6 + 4  ·  1d20 - 2  ·  1d20 + 4 ; 1d8 + 2  ·  3x 1d20 + 6 ; 1d10',
    formulaPreviewEmpty: 'Entrez une formule ou cliquez sur les dés',
    formulaInvalid: 'Formule non reconnue — essayez 2d6 + 4, 3x1d20 + 6, ou 1d20 + 4 ; 1d8 + 2',
    rollBtn: 'Lancer !',
    totalLabel: 'Total',

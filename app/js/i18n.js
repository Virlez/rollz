...
export const i18n = {
  en: {
    ...
    inlineAdvancedToggleConflict: 'Advanced dice syntax cannot be combined with advantage, disadvantage, or success mode',
  },
  fr: {
    ...
    inlineAdvancedToggleConflict: 'La syntaxe de dés avancée ne peut pas être combinée avec l\'avantage, le désavantage ou le mode réussites',
  },
};
